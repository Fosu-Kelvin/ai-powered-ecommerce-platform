...
export const productType = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: "number",
      group: "details",
      description: "Price in GHS (e.g., 599.99)", // Updated description
      validation: (rule) => [
    ...
    defineField({
      ...
      group: "details",
      description:
        "Optional key-value product details for non-standard categories (e.g., Brand, Size, Voltage, Expiry).",
      of: [
        defineArrayMember({
          name: "attribute",
          type: "object",
          fields: [
            defineField({
              ...
              type: "string",
              validation: (rule) =>
                rule.required().error("Attribute name is required"),
            }),
            defineField({
              name: "value",
              ...
              type: "string",
              validation: (rule) =>
                rule.required().error("Attribute value is required"),
            }),
          ],
          preview: {
            select: {
