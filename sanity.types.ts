...
// Query: *[  _type == "category"] | order(title asc) {  _id,  title,  "slug": slug.current,  parentCategory->{    _id,    title,    "slug": slug.current  },  "image": image{    asset->{      _id,      url    },    hotspot  }}
...
// Query: *[  _type == "category"  && slug.current == $slug][0] {  _id,  title,  "slug": slug.current,  parentCategory->{    _id,    title,    "slug": slug.current  },  "image": image{    asset->{      _id,      url    },    hotspot  }}
...
// Query: *[_type == "order" && clerkUserId == $clerkUserId] | order(createdAt desc) {    _id,    orderNumber,    paystackReference, // Include this for the AI to reference    total,    status,    "itemCount": count(items),    "itemNames": items[].product->name,    "itemImages": items[].product->images[0].asset->url,    createdAt  }
...
// Query: *[  _type == "order"  && _id == $id][0] {  _id,  orderNumber,  clerkUserId,  email,  items[]{    _key,    quantity,    priceAtPurchase,    product->{      _id,      name,      "slug": slug.current,      // We wrap it in 'image' and 'asset' to match your DetailPage code      "image": {        "asset": images[0].asset->{          _id,          url        }      }    }  },  total,  status,  address,  paystackReference, // Changed from stripePaymentId to match your new system  createdAt}
...
// Query: *[  _type == "product"] | order(name asc) {  _id,  name,  "slug": slug.current,  description,  price,  "images": images[]{    _key,    asset->{      _id,      url    },    hotspot  },  category->{    _id,    title,    "slug": slug.current,    parentCategory->{      _id,      title,      "slug": slug.current    }  },  material,  color,  dimensions,  customAttributes[]{    name,    value  },  stock,  featured,  assemblyRequired}
...
// Query: *[  _type == "product"  && featured == true  && stock > 0] | order(name asc) [0...6] {  _id,  name,  "slug": slug.current,  description,  price,  "images": images[]{    _key,    asset->{      _id,      url    },    hotspot  },  category->{    _id,    title,    "slug": slug.current,    parentCategory->{      _id,      title,      "slug": slug.current    }  },  stock}
...
// Query: *[  _type == "product"  && category->slug.current == $categorySlug] | order(name asc) {  _id,  name,  "slug": slug.current,  price,  "image": images[0]{    asset->{      _id,      url    },    hotspot  },  category->{    _id,    title,    "slug": slug.current,    parentCategory->{      _id,      title,      "slug": slug.current    }  },  material,  color,  stock}
...
// Query: *[  _type == "product"  && slug.current == $slug][0] {  _id,  name,  "slug": slug.current,  description,  price,  "images": images[]{    _key,    asset->{      _id,      url    },    hotspot  },  category->{    _id,    title,    "slug": slug.current  },  material,  color,  dimensions,  customAttributes[]{    name,    value  },  stock,  featured,  assemblyRequired}
...
// Query: *[  _type == "product"  && (    $searchQuery == ""    || name match $searchQuery + "*"    || description match $searchQuery + "*"    || category->title match $searchQuery + "*"    || category->parentCategory->title match $searchQuery + "*"  )  && ($categorySlug == "" || category->slug.current == $categorySlug || category->parentCategory->slug.current == $categorySlug)  && ($material == "" || material == $material)  && ($color == "" || color == $color)  && ($minPrice == 0 || price >= $minPrice)  && ($maxPrice == 0 || price <= $maxPrice)] | order(name asc) [0...20] {  _id,  name,  "slug": slug.current,  description,  price,  "image": images[0]{    asset->{      _id,      url    }  },  category->{    _id,    title,    "slug": slug.current,    parentCategory->{      _id,      title,      "slug": slug.current    }  },  material,  color,  dimensions,  customAttributes[]{    name,    value  },  stock,  featured,  assemblyRequired}
