...
const productSuggestions = [
  "Show me products under GH₵1000",
  ...
  return (
    <div className="flex h-full flex-col items-center justify-center text-center px-4">
      ...
      <p className="mt-2 text-sm text-zinc-500 dark:text-zinc-400 max-w-xs">
        {isSignedIn
          ? "I can help you find products, check your orders, and track deliveries."
          : "I can help you find products by category, style, color, or price. Just ask!"}
      </p>
